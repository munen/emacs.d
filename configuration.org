...
Emacs 26.1 (which I'm running on Debian stable) requests the GNU Elpa
repo with the wrong TLS version and would fail. This configuration can
be removed once upgraded to 26.3+.
...
#+BEGIN_SRC emacs-lisp
  (setq erc-autojoin-channels-alist '(("freenode.net" "#200ok" "#emacsconf" "#lobsters")))
#+END_SRC
