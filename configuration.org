...
called =fonts-firacode=, in Guix it's =font-fira-code=. However, in
Guix, the font looks a bit off:
https://screenshots.200ok.ch/screenshot_2022_10_26-5bb92403.png

Hence, I'm going with DejaVu Mono Sans for the moment.
...
#+BEGIN_SRC emacs-lisp
  (when (eq system-type 'gnu/linux)
        ...
        ;; This would be my preferred font:
