...
#+begin_src emacs-lisp
  ...
  (gptel-make-tool
   ...
   :name "edit_file"
   :description "Edits a file by applying specific line-based changes. This is a primary method for file modification.
  ...
  Each edit requires a line number, the exact old string to replace, and the new string."
...
(use-package mcp
  ...
  :custom (mcp-hub-servers
           `(("clj-prj" . (:command "/bin/sh"
                      :args ("-c"
                             "cd /home/munen/src/200ok/ukko && clojure -X:mcp :port 7888")))))
