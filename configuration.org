...
-  <code>M-,</code> Brings you back to last place you were when you pressed M-..
...
Pretty print JSON using a standard Python Library.

#+BEGIN_SRC emacs-lisp
(defun pretty-print-json(&optional b e)
  (interactive "r")
  (shell-command-on-region b e "python -m json.tool" t t))
#+END_SRC
*** Emacs Configuration
...
** Generate passwords
   ...
   Thanks to @branch14 for the function!
#+BEGIN_SRC emacs-lisp
