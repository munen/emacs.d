...
#+begin_src emacs-lisp
  ...
  (gptel-make-tool
   ...
   :description "Replaces the entire content of a specified file with new content. IMPORTANT: This tool will completely overwrite the existing file content; user confirmation will be required."
   :args (list
          '(:name "file_path"
                  :type string
