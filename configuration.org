...
and switching buffers. I'm enabling it globally as a fallback.

It's only a fallback, because I'm using the third-party package =ivy=
which is even nicer for generally searching things.
