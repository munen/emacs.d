...
#+begin_src emacs-lisp
  ...
  (defun munen-gptel--replace-buffer (buffer-name content)
  ...
  (gptel-make-tool
   :name "ReplaceBuffer"
   :function #'munen-gptel--replace-buffer
  ...
  (defun munen-gptel--edit-buffer (buffer-name old-string new-string)
  ...
  (gptel-make-tool
   :name "EditBuffer"
   :function #'munen-gptel--edit-buffer
  ...
  (defun munen-gptel--edit_file (file-path file-edits)
  ...
  (with-eval-after-load 'gptel
    (gptel-make-tool
     :function #'munen-gptel--edit_file
     :name "edit_file"
