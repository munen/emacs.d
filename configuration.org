      ...
      (save-mark-and-excursion
        ...
        (shell-command-on-region
         ...
         (cond ((eq strategy 'eslint) (autoformat-prettier-eslint-command))
               ((eq strategy 'html) (autoformat-html-command))
               ((eq strategy 'css) (autoformat-css-command))
               ((eq strategy 'sass) (autoformat-sass-command))
               ((eq strategy 'json) (autoformat-json-command))
               ((eq strategy 'javascript) (autoformat-javascript-command)))
